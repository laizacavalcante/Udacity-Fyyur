...
class Venue(db.Model):
    ...
    venue_shows = db.relationship(
        "Shows", back_populates="venue", cascade="all, delete-orphan", lazy=True
    )  # alimenta a relacao Shows.venue
...
class Artist(db.Model):
    ...
    artist_shows = db.relationship(
        "Shows", back_populates="artist", cascade="all, delete-orphan", lazy=True
    )  # alimenta a relacao Shows.artist
